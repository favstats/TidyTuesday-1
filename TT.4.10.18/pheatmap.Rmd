...
## Plot heat map
pheatmap(dfm, color=colorRampPalette(rev(brewer.pal(11, "RdYlBu")))(100), border_color=NA, cluster_cols=T, cluster_rows=F, filename="pheatmap.tiff", cellwidth=15, cellheight=15)
